// Reserve Bank of Zimbabwe exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/rbz';
...
/** Latest rate for one pair, e.g. getRate('USD', 'ZWG', { apiKey }). */
